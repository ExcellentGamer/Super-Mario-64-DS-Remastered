...
#define DYNOS_LEVEL_TEXT_BOWSER_1           "DYNOS_LEVEL_TEXT_BOWSER_1"
#define DYNOS_LEVEL_TEXT_BOWSER_2           "DYNOS_LEVEL_TEXT_BOWSER_2"
#define DYNOS_LEVEL_TEXT_BOWSER_3           "DYNOS_LEVEL_TEXT_BOWSER_3"
#define DYNOS_LEVEL_TEXT_100_COINS_STAR     "DYNOS_LEVEL_TEXT_100_COINS_STAR"
#define DYNOS_LEVEL_TEXT_RED_COINS_STAR     "DYNOS_LEVEL_TEXT_RED_COINS_STAR"
#define DYNOS_LEVEL_TEXT_ONE_SECRET_STAR    "DYNOS_LEVEL_TEXT_ONE_SECRET_STAR"
#define DYNOS_LEVEL_TEXT_REC_ROOM           "DYNOS_LEVEL_TEXT_REC_ROOM"
...
const u8 *DynOS_Level_GetName(s32 aLevel, bool aDecaps, bool aAddCourseNumber) {
    ...
    } else if (aLevel == LEVEL_REC_ROOM) {
        SetConvertedTextToBuffer(sBuffer, DYNOS_LEVEL_TEXT_REC_ROOM);
...
const u8 *DynOS_Level_GetActName(s32 aLevel, s32 aAct, bool aDecaps, bool aAddStarNumber) {
    ...
    } else if (aAct > NUM_ACTS_PER_COURSE) {
        SetConvertedTextToBuffer(sBuffer, DYNOS_LEVEL_TEXT_100_COINS_STAR);
    } else {
        const u8 *_ActName = ((const u8 **) seg2_act_name_table)[(_Course - COURSE_BOB) * NUM_ACTS_PER_COURSE + (aAct - 1)];
...
const u8 *DynOS_Level_GetAreaName(s32 aLevel, s32 aArea, bool aDecaps) {
    ...
    static const char *sAreaNamesPerLevel[][4] = {
        ...
        { "DYNOS_AREA_TEXT_MAIN_AREA", "DYNOS_AREA_TEXT_NOT_AVAILABLE", "DYNOS_AREA_TEXT_NOT_AVAILABLE", "DYNOS_AREA_TEXT_NOT_AVAILABLE" }, /* Rec room */
    };
    static u8 sBuffer[256];
    memset(sBuffer, 0xFF, 256);
    ...
    switch (aLevel) {
        ...
        case LEVEL_REC_ROOM: SetConvertedTextToBuffer(sBuffer, sAreaNamesPerLevel[31][MIN(MAX(aArea - 1, 0), 3)]); break;
...
s16 *DynOS_Level_GetWarpStarCollect(s32 aLevel, s32 aArea) {
    return DynOS_Level_GetWarp(aLevel, aArea, 0xF0);
}
