...
#define DYNOS_TEXT_CLOSE_LEFT   { "DYNOS_TEXT_CLOSE_LEFT",   NULL }
#define DYNOS_TEXT_OPTIONS_MENU { "DYNOS_TEXT_OPTIONS_MENU", NULL }
#define DYNOS_TEXT_DISABLED     { "DYNOS_TEXT_DISABLED",     NULL }
#define DYNOS_TEXT_ENABLED      { "DYNOS_TEXT_ENABLED",      NULL }
#define DYNOS_TEXT_NONE         { "DYNOS_TEXT_NONE",         NULL }
