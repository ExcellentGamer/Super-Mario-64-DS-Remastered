...
define_actor(yoshi_ds_geo),
define_actor(wario_geo),
define_actor(wario_key_tree_geo),
define_actor(wario_key_house_geo),
define_actor(wario_key_koopa_geo),
define_actor(wario_key_lunar_geo),
define_actor(wario_key_mario_geo),
define_actor(wario_key_pumpkin_geo),
...
define_actor(warp_pipe_boo_purple_locked_geo),
define_actor(warp_pipe_boo_purple_unlocked_geo),
...
static const Array<Pair<const char *, void *>> sGeoFunctions = {
    ...
    define_geo_function(geo_exec_nintendo_start_screen),
    define_geo_function(geo_exec_dsbg_start_screen),
    define_geo_function(geo_exec_ds_goddard_start_screen),
