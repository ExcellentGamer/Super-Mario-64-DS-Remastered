...
const GeoLayout warp_pipe_boo_purple_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_CULLING_RADIUS(74468),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, warp_pipe_boo_purple),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, warp_pipe_boo_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
...
const GeoLayout warp_pipe_boo_purple_locked_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_CULLING_RADIUS(74468),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, warp_pipe_boo_purple_locked),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, warp_pipe_boo_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
...
const GeoLayout warp_pipe_boo_purple_unlocked_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_CULLING_RADIUS(74468),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, warp_pipe_boo_purple_unlocked),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, warp_pipe_boo_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
