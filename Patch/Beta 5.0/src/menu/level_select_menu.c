...
int intro_default(void) {
    ...
    if (D_U_801A7C34 == 1) {
        if (gGlobalTimer < 0x81) {
            r96_play_character_sound_no_arg(R96_MARIO_HELLO, R96_LUIGI_HELLO, R96_WARIO_HELLO, R96_WALUIGI_HELLO, R96_YOSHI_DS_HELLO);
        } else {
            r96_play_character_sound_no_arg(R96_MARIO_PRESS_START_TO_PLAY, R96_LUIGI_PRESS_START_TO_PLAY, R96_WARIO_PRESS_START_TO_PLAY, R96_WALUIGI_PRESS_START_TO_PLAY, R96_YOSHI_DS_PRESS_START_TO_PLAY);
        }
        D_U_801A7C34 = 0;
    }
    print_intro_text();
...
int intro_game_over(void) {
    ...
    if (gameOverNotPlayed == 1) {
        r96_play_character_sound_no_arg(R96_MARIO_GAME_OVER, R96_LUIGI_GAME_OVER, R96_WARIO_GAME_OVER, R96_WALUIGI_GAME_OVER, R96_YOSHI_DS_GAME_OVER);
        gameOverNotPlayed = 0;
    }
...
int intro_play_intro_coin(void) {
...
int intro_play_its_a_me_mario(void) {
    set_background_music(0, SEQ_SOUND_PLAYER, 0);
    play_sound(SOUND_ITS_A_ME_MARIO, gDefaultSoundArgs);
    return 1;
}
