...
void general_star_dance_handler(struct MarioState *m, s32 isInWater) {
    ...
    if (m->actionState == 0) {
        switch (++m->actionTimer) {
            case 1:
                ...
                if (m->actionArg & 1) {
                    ...
                    if (gCurrLevelNum == LEVEL_BOWSER_1 || gCurrLevelNum == LEVEL_BOWSER_2) {
                        r96_play_jingle(R96_EVENT_KEY_COLLECT, 0.1, 1.0, 1);
                        r96_music_fade(1, -1, 0.0, 1, 0);
                    } else {
                        r96_play_jingle(R96_EVENT_STAR_COLLECT, 0.1, 1.0, 1);
                        r96_music_fade(1, -1, 0.0, 1, 0);
                    }
                }
                break;
            ...
            case 42:
                r96_play_character_sound(m, R96_MARIO_HERE_WE_GO, R96_LUIGI_HERE_WE_GO, R96_WARIO_HERE_WE_GO, R96_WALUIGI_HERE_WE_GO, R96_YOSHI_DS_HERE_WE_GO);
                break;
            ...
            case 80:
                if ((m->actionArg & 1) == 0) {
                    ...
                    enable_time_stop();
                    create_dialog_box_with_response(gLastCompletedStarNum == (INDEX_STAR_100_COINS + 1) ? DIALOG_013 : DIALOG_014);
                    m->actionState = 1;
                }
                break;
        }
...
s32 act_standing_death(struct MarioState *m) {
    ...
    r96_play_character_sound_if_no_flag(m, R96_MARIO_DYING, R96_LUIGI_DYING, R96_WARIO_DYING, R96_WALUIGI_DYING, R96_YOSHI_DS_DYING, MARIO_MARIO_SOUND_PLAYED);
    common_death_handler(m, MARIO_ANIM_DYING_FALL_OVER, 80);
    if (m->marioObj->header.gfx.curAnim.animFrame == 77) {
...
s32 act_quicksand_death(struct MarioState *m) {
    ...
    if (m->actionState == 1) {
        if (m->quicksandDepth >= 100.0f) {
            r96_play_character_sound_if_no_flag(m, R96_MARIO_FALLING, R96_LUIGI_FALLING, R96_WARIO_FALLING, R96_WALUIGI_FALLING, R96_YOSHI_DS_FALLING, MARIO_MARIO_SOUND_PLAYED);
        }
...
s32 act_unlocking_key_door(struct MarioState *m) {
    ...
    switch (m->marioObj->header.gfx.curAnim.animFrame) {
        case 79:
...
s32 act_character_switch(struct MarioState *m) {
    ...
    if(m->actionArg) {
        if(!alreadyPlayed){
            r96_play_character_sound_if_no_flag(m, R96_MARIO_YAHOO, R96_LUIGI_YAHOO, R96_WARIO_YAHOO, R96_WALUIGI_YAHOO, R96_YOSHI_DS_YAHOO, MARIO_MARIO_SOUND_PLAYED);
...
s32 act_bbh_enter_spin(struct MarioState *m) {
    ...
    switch (m->actionState) {
        ...
        case 3:
            ...
            if (m->actionState == 2) {
                if (m->marioObj->header.gfx.curAnim.animFrame == 0) {
                    m->actionState = 3;
                }
            } else {
...
s32 act_shocked(struct MarioState *m) {
    r96_play_character_sound_if_no_flag(m, R96_MARIO_FALLING, R96_LUIGI_FALLING, R96_WARIO_FALLING, R96_WALUIGI_FALLING, R96_YOSHI_DS_FALLING, MARIO_ACTION_SOUND_PLAYED);
        ...
        case 0:
            ...
            if (spaceUnderCeil >= 10.1f) {
                ...
                if (!(m->flags & MARIO_METAL_CAP) && m->invincTimer == 0) {
                    ...
                    r96_play_character_sound_if_no_flag(m, R96_MARIO_ATTACKED, R96_LUIGI_ATTACKED, R96_WARIO_ATTACKED, R96_WALUIGI_ATTACKED, R96_YOSHI_DS_ATTACKED, MARIO_MARIO_SOUND_PLAYED);
                }
...
static void intro_cutscene_jump_out_of_pipe(struct MarioState *m) {
    ...
    if (m->actionTimer++ >= 118) {
        ...
        if (perform_air_step(m, 0) == AIR_STEP_LANDED) {
            ...
            play_mario_landing_sound(m, SOUND_ACTION_TERRAIN_LANDING);
            r96_play_character_sound(m, R96_MARIO_HAHA, R96_LUIGI_HAHA, R96_WARIO_HAHA, R96_WALUIGI_HAHA, R96_YOSHI_DS_HAHA);
            advance_cutscene_step(m);
        }
    }
}
...
static void jumbo_star_cutscene_falling(struct MarioState *m) {
    if (m->actionState == 0) {
        ...
        if (perform_air_step(m, 1) == AIR_STEP_LANDED) {
            r96_stop_music();
            r96_play_jingle(R96_EVENT_VICTORY, 0.1, 1.0, 1500);
            play_mario_landing_sound(m, SOUND_ACTION_TERRAIN_LANDING);
            m->actionState++;
        }
    } else {
...
static s32 jumbo_star_cutscene_taking_off(struct MarioState *m) {
    ...
    if (m->actionState == 0) {
        ...
        switch (animFrame) {
            ...
            case 28:
                r96_play_character_sound(m, R96_MARIO_HOOHOO, R96_LUIGI_HOOHOO, R96_WARIO_HOOHOO, R96_WALUIGI_HOOHOO, R96_YOSHI_DS_HOOHOO);
                break;

            case 60:
                r96_play_character_sound(m, R96_MARIO_YAHOO, R96_LUIGI_YAHOO, R96_WARIO_YAHOO, R96_WALUIGI_YAHOO, R96_YOSHI_DS_YAHOO);
                break;
        }
        m->particleFlags |= PARTICLE_SPARKLES;
...
static void end_peach_cutscene_summon_jumbo_star(struct MarioState *m) {
    ...
    if (m->actionTimer == 90) {
        r96_play_jingle(R96_EVENT_PEACH_ENDING, 0.1, 1.0, 1500);
    }
...
static void end_peach_cutscene_dialog_1(struct MarioState *m) {
    ...
    switch (m->actionTimer) {
        ...
        case 230:
            ...
            r96_play_character_sound(m, R96_MARIO_PEACH_MARIO, R96_LUIGI_PEACH_LUIGI, R96_WARIO_PEACH_WARIO, R96_WALUIGI_PEACH_WALUIGI, R96_YOSHI_DS_PEACH_YOSHI_DS);
            break;
        ...
        case 290:
            ...
            r96_play_character_sound(m, R96_MARIO_PEACH_POWER_OF_THE_STARS, R96_LUIGI_PEACH_POWER_OF_THE_STARS, R96_WARIO_PEACH_POWER_OF_THE_STARS, R96_WALUIGI_PEACH_POWER_OF_THE_STARS, R96_YOSHI_DS_PEACH_POWER_OF_THE_STARS);
            break;
...
static void end_peach_cutscene_dialog_2(struct MarioState *m) {
    ...
    switch (m->actionTimer) {
        case 29:
            ...
            r96_play_character_sound(m, R96_MARIO_PEACH_THANKS_TO_YOU, R96_LUIGI_PEACH_THANKS_TO_YOU, R96_WARIO_PEACH_THANKS_TO_YOU, R96_WALUIGI_PEACH_THANKS_TO_YOU, R96_YOSHI_DS_PEACH_THANKS_TO_YOU);
            break;
        ...
        case 75:
            ...
            r96_play_character_sound(m, R96_MARIO_PEACH_THANK_YOU_MARIO, R96_LUIGI_PEACH_THANK_YOU_LUIGI, R96_WARIO_PEACH_THANK_YOU_WARIO, R96_WALUIGI_PEACH_THANK_YOU_WALUIGI, R96_YOSHI_DS_PEACH_THANK_YOU_YOSHI_DS);
            break;

        case TIMER_SOMETHING_SPECIAL:
            set_cutscene_message(160, 227, 4, 40);
            r96_play_character_sound(m, R96_MARIO_PEACH_SOMETHING_SPECIAL, R96_LUIGI_PEACH_SOMETHING_SPECIAL, R96_WARIO_PEACH_SOMETHING_SPECIAL, R96_WALUIGI_PEACH_SOMETHING_SPECIAL, R96_YOSHI_DS_PEACH_SOMETHING_SPECIAL);
            break;
...
static void end_peach_cutscene_dialog_3(struct MarioState *m) {
    ...
    switch (m->actionTimer) {
        case 1:
            ...
            r96_play_character_sound(m, R96_MARIO_PEACH_BAKE_A_CAKE, R96_LUIGI_PEACH_BAKE_A_CAKE, R96_WARIO_PEACH_BAKE_A_CAKE, R96_WALUIGI_PEACH_BAKE_A_CAKE, R96_YOSHI_DS_PEACH_BAKE_A_CAKE);
            break;
        ...
        case 130:
            ...
            r96_play_character_sound(m, R96_MARIO_PEACH_FOR_MARIO, R96_LUIGI_PEACH_FOR_LUIGI, R96_WARIO_PEACH_FOR_WARIO, R96_WALUIGI_PEACH_FOR_WALUIGI, R96_YOSHI_DS_PEACH_FOR_YOSHI_DS);
            break;
    }
...
static void end_peach_cutscene_run_to_castle(struct MarioState *m) {
    ...
    if (m->actionTimer == 95) {
        ...
        r96_play_character_sound(m, R96_MARIO_SOUND_PEACH_MARIO2, R96_LUIGI_SOUND_PEACH_LUIGI2, R96_WARIO_SOUND_PEACH_WARIO2, R96_WALUIGI_SOUND_PEACH_WALUIGI2, R96_YOSHI_DS_SOUND_PEACH_YOSHI_DS2);
    }
