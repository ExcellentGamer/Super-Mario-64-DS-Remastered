...
static s32 act_drowning(struct MarioState *m) {
    ...
    r96_play_character_sound_if_no_flag(m, R96_MARIO_DROWNING, R96_LUIGI_DROWNING, R96_WARIO_DROWNING, R96_WALUIGI_DROWNING, R96_YOSHI_DS_DROWNING, MARIO_MARIO_SOUND_PLAYED);
    stationary_slow_down(m);
    perform_water_step(m);
