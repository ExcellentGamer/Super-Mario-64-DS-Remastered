...
void play_step_sound(struct MarioState *m, s16 frame1, s16 frame2) {
    if (is_anim_past_frame(m, frame1) || is_anim_past_frame(m, frame2)) {
        if (m->flags & MARIO_METAL_CAP) {
            if (m->marioObj->header.gfx.curAnim.animID == MARIO_ANIM_TIPTOE) {
        ...
        } else if (m->marioObj->header.gfx.curAnim.animID == MARIO_ANIM_TIPTOE) {
...
void push_or_sidle_wall(struct MarioState *m, Vec3f startPos) {
    ...
    if (m->wall == NULL || dWallAngle <= -0x71C8 || dWallAngle >= 0x71C8) {
        ...
        if (m->marioObj->header.gfx.curAnim.animFrame < 20) {
...
s32 common_ground_knockback_action(struct MarioState *m, s32 animation, s32 arg2, s32 arg3, s32 arg4) {
    ...
    if (arg4 > 0) {
        ...
        r96_play_character_sound_if_no_flag(m, R96_MARIO_OOOF, R96_LUIGI_OOOF, R96_WARIO_OOOF, R96_WALUIGI_OOOF, R96_YOSHI_DS_OOOF, MARIO_MARIO_SOUND_PLAYED);
    }
...
s32 act_hard_backward_ground_kb(struct MarioState *m) {
    ...
    if (val04 == 0x36 && m->prevAction == ACT_SPECIAL_DEATH_EXIT) {
        r96_play_character_sound(m, R96_MARIO_MAMA_MIA, R96_LUIGI_MAMA_MIA, R96_WARIO_MAMA_MIA, R96_WALUIGI_MAMA_MIA, R96_YOSHI_DS_MAMA_MIA);
    }
...
s32 act_long_jump_land(struct MarioState *m) {
    ...
    if (!(m->input & INPUT_NONZERO_ANALOG)) {
        r96_play_character_sound_if_no_flag(m, R96_MARIO_GRUNT_2, R96_LUIGI_GRUNT_2, R96_WARIO_GRUNT_2, R96_WALUIGI_GRUNT_2, R96_YOSHI_DS_GRUNT_2, MARIO_MARIO_SOUND_PLAYED);
    }
...
s32 act_triple_jump_land(struct MarioState *m) {
    ...
    if (!(m->input & INPUT_NONZERO_ANALOG)) {
        r96_play_character_sound_if_no_flag(m, R96_MARIO_HAHA, R96_LUIGI_HAHA, R96_WARIO_HAHA, R96_WALUIGI_HAHA, R96_YOSHI_DS_HAHA, MARIO_MARIO_SOUND_PLAYED);
    }
