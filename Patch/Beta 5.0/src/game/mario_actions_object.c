...
s32 mario_update_punch_sequence(struct MarioState *m) {
    ...
    switch (m->actionArg) {
        case 0:
            r96_play_character_sound(m, R96_MARIO_YAH, R96_LUIGI_YAH, R96_WARIO_YAH, R96_WALUIGI_YAH, R96_YOSHI_DS_YAH);
            // Fall-through:
        case 1:
            ...
            if (m->marioObj->header.gfx.curAnim.animFrame >= 2) {
        ...
        case 3:
            r96_play_character_sound(m, R96_MARIO_WAH, R96_LUIGI_WAH, R96_WARIO_WAH, R96_WALUIGI_WAH, R96_YOSHI_DS_WAH);
            // Fall-through:
        case 4:
        ...
        case 6:
            ...
            if (animFrame == 0) {
                ...
                r96_play_character_sound(m, R96_MARIO_PUNCH_HOO, R96_LUIGI_PUNCH_HOO, R96_WARIO_PUNCH_HOO, R96_WALUIGI_PUNCH_HOO, R96_YOSHI_DS_PUNCH_HOO);
            }
...
s32 act_picking_up(struct MarioState *m) {
    ...
    if (m->actionState == 0 && is_anim_at_end(m)) {
        ...
        r96_play_character_sound_if_no_flag(m, R96_MARIO_LIFT, R96_LUIGI_LIFT, R96_WARIO_LIFT, R96_WALUIGI_LIFT, R96_YOSHI_DS_LIFT, MARIO_MARIO_SOUND_PLAYED);
        m->actionState = 1;
    }
    ...
    if (m->actionState == 1) {
        if (m->heldObj->oInteractionSubtype & INT_SUBTYPE_GRABS_MARIO) {
            ...
            if (isWario() && (script == bhvMotos || script == bhvHeaveHo)) {
                m->marioBodyState->grabPos = GRAB_POS_MOTOS_OBJ;
            } else { 
...
s32 act_picking_up_bowser(struct MarioState *m) {
    if (m->actionState == 0) {
        ...
        r96_play_character_sound(m, R96_MARIO_LIFT, R96_LUIGI_LIFT, R96_WARIO_LIFT, R96_WALUIGI_LIFT, R96_YOSHI_DS_LIFT);
    }
...
s32 act_holding_bowser(struct MarioState *m) {
    ...
    if (m->input & INPUT_B_PRESSED) {
        if (m->angleVel[1] <= -0xE00 || m->angleVel[1] >= 0xE00) {
            r96_play_character_sound(m, R96_MARIO_SO_LONGA_BOWSER, R96_LUIGI_SO_LONGA_BOWSER, R96_WARIO_SO_LONGA_BOWSER, R96_WALUIGI_SO_LONGA_BOWSER, R96_YOSHI_DS_SO_LONGA_BOWSER);
        } else {
