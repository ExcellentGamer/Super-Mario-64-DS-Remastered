...
extern Gfx *geo_exec_nintendo_start_screen(s32 callContext, struct GraphNode *node, UNUSED f32 mtx[4][4]);
extern Gfx *geo_exec_dsbg_start_screen(s32 callContext, struct GraphNode *node, UNUSED f32 mtx[4][4]);
extern Gfx *geo_exec_ds_goddard_start_screen(s32 callContext, struct GraphNode *node, UNUSED f32 mtx[4][4]);
