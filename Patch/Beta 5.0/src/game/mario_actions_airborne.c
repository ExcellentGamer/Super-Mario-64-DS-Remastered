...
void play_flip_sounds(struct MarioState *m, s16 frame1, s16 frame2, s16 frame3) {
    s32 animFrame = m->marioObj->header.gfx.curAnim.animFrame;
...
s32 lava_boost_on_wall(struct MarioState *m) {
    ...
    r96_play_character_sound(m, R96_MARIO_ON_FIRE, R96_LUIGI_ON_FIRE, R96_WARIO_ON_FIRE, R96_WALUIGI_ON_FIRE, R96_YOSHI_DS_ON_FIRE);
    ...
    if (m->action != ACT_TWIRLING && m->floor->type != SURFACE_BURNING) {
        if (m->vel[1] < -55.0f) {
            if (fallHeight > 3000.0f) {
                if (m->action != ACT_WARIO_PILE_DRIVER || m->milk == 1) {
                    m->hurtCounter += (m->flags & MARIO_CAP_ON_HEAD) ? 16 : 24;
                    queue_rumble_data(5, 80);
                    set_camera_shake_from_hit(SHAKE_FALL_DAMAGE);
                    r96_play_character_sound(m, R96_MARIO_ATTACKED, R96_LUIGI_ATTACKED, R96_WARIO_ATTACKED, R96_WALUIGI_ATTACKED, R96_YOSHI_DS_ATTACKED);
...
u32 common_air_action_step(struct MarioState *m, u32 landAction, s32 animation, u32 stepArg) {
    u32 stepResult;
    s16 animID = m->marioObj->header.gfx.curAnim.animID;
    ...
    switch (stepResult) {
        case AIR_STEP_NONE:
            ...
            if ((animation == MARIO_ANIM_SINGLE_JUMP && isLuigi() || isWaluigi() || isYoshi()) && (animID == MARIO_ANIM_FORWARD_FLIP || is_anim_at_end(m))) {
...
void flutterJump(struct MarioState *m){
    if (m->vel[1] < 0 && m->input & INPUT_A_DOWN && isLuigi() || isWaluigi() && !(m->flags & MARIO_WING_CAP)) {                
        m->vel[1] += 2.3;
        if(m->forwardVel > 0){
            m->forwardVel -= 1.2;
        }
...
void yoshiFlutterJump(struct MarioState *m){
     if (m->vel[1] < 0 && m->input & INPUT_A_DOWN && isYoshi() && !(m->flags & MARIO_WING_CAP)) {
        flutterTimer++;
...
s32 act_double_jump(struct MarioState *m) {
    ...
    r96_play_character_sound_if_no_flag(m, R96_MARIO_HOOHOO, R96_LUIGI_HOOHOO, R96_WARIO_HOOHOO, R96_WALUIGI_HOOHOO, R96_YOSHI_DS_HOOHOO, MARIO_MARIO_SOUND_PLAYED);
    r96_play_action_sound(m, SOUND_ACTION_TERRAIN_JUMP);
...
s32 act_backflip(struct MarioState *m) {
    ...
    if(isLuigi() || isWaluigi()==1 && m->vel[1] < 0){
...
s32 act_side_flip(struct MarioState *m) {
    ...
    // clang-format off
    if (m->marioObj->header.gfx.curAnim.animFrame == 6) play_sound(SOUND_ACTION_SIDE_FLIP_UNK, m->marioObj->header.gfx.cameraToObject);
    // clang-format on
    return FALSE;
}
...
s32 act_long_jump(struct MarioState *m) {
    ...
    r96_play_character_sound_if_no_flag(m, R96_MARIO_YAHOO, R96_LUIGI_YAHOO, R96_WARIO_YAHOO, R96_WALUIGI_YAHOO, R96_YOSHI_DS_YAHOO, MARIO_MARIO_SOUND_PLAYED); //SOUND_ACTION_TERRAIN_JUMP
...
s32 act_dive(struct MarioState *m) {
    if (m->actionArg == 0) {
        r96_play_character_sound_if_no_flag(m, R96_MARIO_HOOHOO, R96_LUIGI_HOOHOO, R96_WARIO_HOOHOO, R96_WALUIGI_HOOHOO, R96_YOSHI_DS_HOOHOO, MARIO_MARIO_SOUND_PLAYED);
        r96_play_action_sound(m, SOUND_ACTION_THROW);
    } else {
        r96_play_action_sound(m, SOUND_ACTION_TERRAIN_JUMP);
        r96_play_character_jump_sound(m);
    }
...
s32 act_air_throw(struct MarioState *m) {
    ...
    r96_play_character_sound_if_no_flag(m, R96_MARIO_THROW, R96_LUIGI_THROW, R96_WARIO_THROW, R96_WALUIGI_THROW, R96_YOSHI_DS_THROW, MARIO_MARIO_SOUND_PLAYED);
...
s32 act_water_jump(struct MarioState *m) {
    ...
    r96_play_action_sound(m, SOUND_ACTION_UNKNOWN432);
    r96_play_character_jump_sound(m);
...
s32 act_ground_pound(struct MarioState *m) {
    ...
    if (m->actionState == 0) {
        ...
        if (m->actionTimer >= m->marioObj->header.gfx.curAnim.curAnim->unk08 + 4) {
            r96_play_character_sound(m, R96_MARIO_THROW, R96_LUIGI_THROW, R96_WARIO_THROW, R96_WALUIGI_THROW, R96_YOSHI_DS_THROW);
            m->actionState = 1;
        }
    } else {
...
s32 act_backward_rollout(struct MarioState *m) {
    ...
    if (m->actionState == 1 && m->marioObj->header.gfx.curAnim.animFrame == 2) {
        m->actionState = 2;
    }
    return FALSE;
}
...
s32 act_lava_boost(struct MarioState *m) {
    if (!(m->flags & MARIO_MARIO_SOUND_PLAYED)) {
        r96_play_character_sound_if_no_flag(m, R96_MARIO_ON_FIRE, R96_LUIGI_ON_FIRE, R96_WARIO_ON_FIRE, R96_WALUIGI_ON_FIRE, R96_YOSHI_DS_ON_FIRE, MARIO_MARIO_SOUND_PLAYED);
        queue_rumble_data(5, 80);
    }
    r96_play_character_sound_if_no_flag(m, R96_MARIO_ON_FIRE, R96_LUIGI_ON_FIRE, R96_WARIO_ON_FIRE, R96_WALUIGI_ON_FIRE, R96_YOSHI_DS_ON_FIRE, MARIO_MARIO_SOUND_PLAYED);
...
s32 act_jump_kick(struct MarioState *m) {
    ...
    if (m->actionState == 0) {
        r96_play_character_sound_if_no_flag(m, R96_MARIO_PUNCH_HOO, R96_LUIGI_PUNCH_HOO, R96_WARIO_PUNCH_HOO, R96_WALUIGI_PUNCH_HOO, R96_YOSHI_DS_PUNCH_HOO, MARIO_MARIO_SOUND_PLAYED);
...
s32 act_flying(struct MarioState *m) {
    ...
    if (m->actionState == 0) {
        if (m->actionArg == 0) {
            ...
            if (m->marioObj->header.gfx.curAnim.animFrame == 1) {
                play_sound(SOUND_ACTION_SPIN, m->marioObj->header.gfx.cameraToObject);
            }
        }
    ...
    if (startPitch <= 0 && m->faceAngle[0] > 0 && m->forwardVel >= 48.0f) {
        ...
        r96_play_character_flying_sound(m);
...
s32 act_flying_triple_jump(struct MarioState *m) {
    ...
    if (m->actionState == 0) {
        ...
        if (m->marioObj->header.gfx.curAnim.animFrame == 7) {
            play_sound(SOUND_ACTION_SPIN, m->marioObj->header.gfx.cameraToObject);
        }
    ...
    if (m->actionState == 1 && m->marioObj->header.gfx.curAnim.animFrame == 1) {
        play_sound(SOUND_ACTION_SPIN, m->marioObj->header.gfx.cameraToObject);
    }
...
s32 act_vertical_wind(struct MarioState *m) {
    ...
    r96_play_character_sound_if_no_flag(m, R96_MARIO_HERE_WE_GO, R96_LUIGI_HERE_WE_GO, R96_WARIO_HERE_WE_GO, R96_WALUIGI_HERE_WE_GO, R96_YOSHI_DS_HERE_WE_GO, MARIO_MARIO_SOUND_PLAYED);
    if (m->actionState == 0) {
        set_mario_animation(m, MARIO_ANIM_FORWARD_SPINNING_FLIP);
        if (m->marioObj->header.gfx.curAnim.animFrame == 1) {
            play_sound(SOUND_ACTION_SPIN, m->marioObj->header.gfx.cameraToObject);
