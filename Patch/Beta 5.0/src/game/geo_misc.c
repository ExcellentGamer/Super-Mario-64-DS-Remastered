...
/**
 * Create a display list for the nintendo screen in the opening.
 */
Gfx *geo_exec_nintendo_start_screen(s32 callContext, struct GraphNode *node, UNUSED f32 mtx[4][4]) {
    struct GraphNodeGenerated *generatedNode = (struct GraphNodeGenerated *) node;
    Gfx *displayList = NULL;
    Gfx *displayListHead = NULL;
    ...
    if (callContext == GEO_CONTEXT_RENDER) {
        ...
        s32 x = -80;
        s32 y = 0;
        u32 w = SCREEN_HEIGHT * 2700 / 1350;
        u32 h = SCREEN_HEIGHT;
        u8 *texture = "levels/nintendo/ds_nintendo";
...
/**
 * Create a display list for the DS Intro
 */
Gfx *geo_exec_dsbg_start_screen(s32 callContext, struct GraphNode *node, UNUSED f32 mtx[4][4]) {
    struct GraphNodeGenerated *generatedNode = (struct GraphNodeGenerated *) node;
    Gfx *displayList = NULL;
    Gfx *displayListHead = NULL;
...
/**
 * Create a display list for the DS Goddard Area
 */
Gfx *geo_exec_ds_goddard_start_screen(s32 callContext, struct GraphNode *node, UNUSED f32 mtx[4][4]) {
    struct GraphNodeGenerated *generatedNode = (struct GraphNodeGenerated *) node;
    Gfx *displayList = NULL;
    Gfx *displayListHead = NULL;
    ...
    if (callContext == GEO_CONTEXT_RENDER) {
        ...
        u32 w = SCREEN_HEIGHT * 2700 / 1350;
        u32 h = SCREEN_HEIGHT;
        u8 *texture = "levels/intro/ds_goddard";
