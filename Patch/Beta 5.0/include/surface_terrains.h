...
#define SURFACE_PAINTING_WOBBLE_C7           0x00C7 // Painting wobble (GB - Left)
#define SURFACE_PAINTING_WOBBLE_C8           0x00C8 // Painting wobble (GB - Middle)
#define SURFACE_PAINTING_WOBBLE_C9           0x00C9 // Painting wobble (GB - Right)
...
#define SURFACE_PAINTING_WARP_E5             0x00E5 // Painting warp (GB - Left)
#define SURFACE_PAINTING_WARP_E6             0x00E6 // Painting warp (GB - Medium)
#define SURFACE_PAINTING_WARP_E7             0x00E7 // Painting warp (GB - Right)
