...
#define ACT_WARIO_CHARGE               (0x041 | ACT_FLAG_MOVING | ACT_FLAG_ATTACKING)
...
#define ACT_WARIO_TRIPLE_JUMP          (0x084 | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION | ACT_FLAG_CONTROL_JUMP_HEIGHT)
...
#define ACT_CHARACTER_SWITCH           (0x10B | ACT_FLAG_AIR | ACT_FLAG_INTANGIBLE)
...
#define ACT_PICKING_UP_ENEMIES         (0x193 | ACT_FLAG_STATIONARY | ACT_FLAG_ATTACKING | ACT_FLAG_INVULNERABLE)
#define ACT_HOLDING_ENEMIES            (0x194 | ACT_FLAG_STATIONARY | ACT_FLAG_ATTACKING | ACT_FLAG_INVULNERABLE)
#define ACT_RELEASING_ENEMIES          (0x195 | ACT_FLAG_STATIONARY | ACT_FLAG_ATTACKING | ACT_FLAG_INVULNERABLE)
#define ACT_WARIO_PILE_DRIVER          (0x196 | ACT_FLAG_AIR | ACT_FLAG_ATTACKING | ACT_FLAG_INVULNERABLE)
#define ACT_WARIO_PILE_DRIVER_LAND     (0x197 | ACT_FLAG_STATIONARY | ACT_FLAG_ATTACKING | ACT_FLAG_INVULNERABLE)
