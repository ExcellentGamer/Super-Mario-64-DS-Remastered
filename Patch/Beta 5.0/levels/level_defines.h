...
DEFINE_LEVEL("BATTLE FIELD", LEVEL_BOB, COURSE_BOB, bob, generic, 20000, 0x00, 0x00, 0x00, _, sCamBOB) 
...
STUB_LEVEL("", LEVEL_UNKNOWN_38, COURSE_NONE, 20000, 0x00, 0x00, 0x00, sDyncurAnim, _) 
DEFINE_LEVEL("REC_ROOM", LEVEL_REC_ROOM, COURSE_REC_ROOM, rec_room, generic, 20000, 0x00, 0x00, 0x00, _, sCamRecRoom) 
