...
#include "levels/nintendo/header.h"

const LevelScript level_intro_nintendo[] = {
    INIT_LEVEL(),
    FIXED_LOAD(/*loadAddr*/ _goddardSegmentStart, /*romStart*/ _goddardSegmentRomStart, /*romEnd*/ _goddardSegmentRomEnd),
    LOAD_RAW(/*seg*/ 0x13, _behaviorSegmentRomStart, _behaviorSegmentRomEnd),
    LOAD_MIO0(/*seg*/ 0x7, _nintendo_segment_7SegmentRomStart, _nintendo_segment_7SegmentRomEnd), 
    ALLOC_LEVEL_POOL(),

    AREA(/*index*/ 1, nintendo_geo),
    END_AREA(),
    ...
    TRANSITION(/*transType*/ WARP_TRANSITION_FADE_FROM_COLOR, /*time*/ 20, /*color*/ 0xFF, 0xFF, 0xFF),
    SLEEP(/*frames*/ 90),
...
const LevelScript level_intro_entry_1[] = {
    ...
    AREA(/*index*/ 1, dsbg_geo),
    END_AREA(),

    FREE_LEVEL_POOL(),
    LOAD_AREA(/*area*/ 1),
    CALL(/*arg*/ 0, /*func*/ lvl_title_theme),
    TRANSITION(/*transType*/ WARP_TRANSITION_FADE_FROM_COLOR, /*time*/ 20, /*color*/ 0x00, 0x00, 0x00),
    SLEEP(/*frames*/ 90),
    TRANSITION(/*transType*/ WARP_TRANSITION_FADE_INTO_COLOR, /*time*/ 20, /*color*/ 0xFF, 0xFF, 0xFF),
    SLEEP(/*frames*/ 21),
    CMD2A(/*unk2*/ 1),
    CLEAR_LEVEL(),
    SLEEP(/*frames*/ 2),
...
const LevelScript level_intro_entry_3[] = {
    ...
    BLACKOUT(/*active*/ FALSE),
    LOAD_AREA(/*area*/ 1),
    CALL(/*arg*/ 0, /*func*/ lvl_gameover_theme),
    SLEEP(/*frames*/ 20),
