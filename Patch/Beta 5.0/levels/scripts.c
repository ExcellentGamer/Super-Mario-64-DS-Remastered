...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_YOSHI_DS,                yoshi_ds_geo),
	...
	LOAD_MODEL_FROM_GEO(MODEL_wario_key_PUMPKIN,      wario_key_pumpkin_geo),
	LOAD_MODEL_FROM_GEO(MODEL_wario_key_HOUSE,        wario_key_house_geo),
	LOAD_MODEL_FROM_GEO(MODEL_wario_key_TREE,         wario_key_tree_geo),
	LOAD_MODEL_FROM_GEO(MODEL_wario_key_KOOPA,        wario_key_koopa_geo),
	LOAD_MODEL_FROM_GEO(MODEL_wario_key_LUNAR,        wario_key_lunar_geo),
	LOAD_MODEL_FROM_GEO(MODEL_wario_key_MARIO,        wario_key_mario_geo),
	...
	LOAD_MODEL_FROM_GEO(MODEL_PLAYER_LOCK_SWITCH_PURPLE_LOCKED_PIPE, warp_pipe_boo_purple_locked_geo), 
	LOAD_MODEL_FROM_GEO(MODEL_PLAYER_LOCK_SWITCH_PURPLE_UNLOCKED_PIPE, warp_pipe_boo_purple_unlocked_geo), 
...
static const LevelScript script_NINTENDO[] = {
    EXIT_AND_EXECUTE(/*seg*/ 0x14, _introSegmentRomStart, _introSegmentRomEnd, level_intro_nintendo),
};
...
const LevelScript script_func_global_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BLACK_BOBOMB,            bobomb_geo),
...
const LevelScript script_func_global_9[] = {
    ...
    LOAD_MODEL_FROM_GEO( MODEL_CAP_SWITCH_BASE,        cap_switch_base_geo),
    RETURN(),
};
