...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(/*model*/ MODEL_wario_key_TREE, /*pos*/ -5914,  -383,  -1110, /*angle*/ 0, 0, 0, /*behParam*/ 2, /*beh*/ bhvWarioKey),
    OBJECT(/*model*/ MODEL_wario_key_KOOPA, /*pos*/ 4287,  685,  -4391, /*angle*/ 0, 0, 0, /*behParam*/ 3, /*beh*/ bhvWarioKey),
    RETURN(),
};
