...
// 0x0700D030 - 0x0700D090 - TOP
static const Vtx ttm_seg7_vertex_0700D030[] = {
    {{{   810,    307,    659}, 0, { 11600,  -1172}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -302,    307,   -327}, 0, {  9380,  -3138}, {0x00, 0x7f, 0x00, 0xff}}},

    {{{  -923,    305,   -206}, 0, {  8144,  -2896}, {0x00, 0x7f, 0x00, 0xff}}},

    {{{  -166,    308,   -479}, 0, {  9650,  -3444}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -538,    307,   -802}, 0, {  8914,  -4092}, {0x00, 0x7f, 0x00, 0xff}}},

    {{{   675,    308,    811}, 0, { 11332,   -868}, {0x00, 0x7f, 0x00, 0xff}}},
};
