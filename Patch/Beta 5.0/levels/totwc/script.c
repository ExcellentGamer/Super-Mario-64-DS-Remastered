...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(/*model*/ MODEL_wario_key_PUMPKIN, /*pos*/ 4045,  490,  5154, /*angle*/ 0, 0, 0, /*behParam*/ 0, /*beh*/ bhvWarioKey),
    OBJECT(/*model*/ MODEL_wario_key_HOUSE, /*pos*/ -698,  1799,  0, /*angle*/ 0, 0, 0, /*behParam*/ 1, /*beh*/ bhvWarioKey),
    RETURN(),
};
