...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT_WITH_ACTS(MODEL_DL_CANNON_LID, -5704, -920, 5606, 0, -180, 0, 0x00000000, bhvCannonClosed, ALL_ACTS),
		...
		OBJECT_WITH_ACTS(MODEL_NONE, 1512, 2787, -5659, 0, -147, 0, 0x00000000, bhvTtmBowlingBallSpawner, ACT_3 | ACT_4 | ACT_5 | ACT_6 | ACT_7),
		OBJECT_WITH_ACTS(MODEL_NONE, 433, 1776, -5558, 0, -151, 0, 0x00020000, bhvBobBowlingBallSpawner, ACT_1 | ACT_2),
		OBJECT_WITH_ACTS(MODEL_NONE, 433, 1776, -5558, 0, -151, 0, 0x00020000, bhvTtmBowlingBallSpawner, ACT_3 | ACT_4 | ACT_5 | ACT_6 | ACT_7),
		...
		OBJECT_WITH_ACTS(MODEL_BOBOMB_BUDDY, -6093, -1048, 6656, 0, 0, 0, DIALOG_003 << 16, bhvBobombBuddy, ALL_ACTS),
		OBJECT_WITH_ACTS(MODEL_BOBOMB_BUDDY, -5632, -895, 5939, 0, 0, 0, DIALOG_002 << 16, bhvBobombBuddyOpensCannon, ALL_ACTS),
		OBJECT_WITH_ACTS(MODEL_BOBOMB_BUDDY, -4314, -1048, 5119, 0, 0, 0, DIALOG_003 << 16, bhvBobombBuddy, ALL_ACTS),
		...
		OBJECT_WITH_ACTS(MODEL_STAR, 7014, 939, -5376, 0, 0, 0, 0x00020000, bhvSm64DsSilverStar, ACT_3),
		OBJECT_WITH_ACTS(MODEL_STAR, -4296, -280, 2310, 0, 0, 0, 0x00020000, bhvSm64DsSilverStar, ACT_3),
		OBJECT(MODEL_WOODEN_SIGNPOST, -4588, -1048, 5435, 0, -90, 0, DIALOG_033, bhvSignOnWall),
		OBJECT_WITH_ACTS(MODEL_STAR, -1509, -75, 5093, 0, 0, 0, 0x00000000, bhvSm64DsSilverStar, ACT_3),
		OBJECT_WITH_ACTS(MODEL_STAR, -6298, 27, -5274, 0, 0, 0, 0x00000000, bhvSm64DsSilverStar, ACT_3),
		OBJECT_WITH_ACTS(MODEL_NONE, -4477, -792, 5637, 0, 0, 0, 0x00020000, bhvSm64DsStarSpawnCondition, ACT_3),
		...
		OBJECT_WITH_ACTS(MODEL_KING_BOBOMB, 3072, 3244, -4710, 0, -146, 0, 0x00000000, bhvKingBobomb, ACT_1),
