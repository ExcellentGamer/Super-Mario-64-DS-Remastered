...
const GeoLayout rec_room_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, 0, -1048, 0, rec_room_dl_Rec_Room_mesh_layer_4),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, rec_room_dl_Rec_Room_mesh_layer_1),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, rec_room_dl_Rec_Room_mesh_layer_5),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout rec_room_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_BRANCH(1, rec_room_area_1_geo),
					GEO_RENDER_OBJ(),
