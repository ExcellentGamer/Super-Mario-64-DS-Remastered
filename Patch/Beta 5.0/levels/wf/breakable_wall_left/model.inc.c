...
static const Vtx wf_seg7_vertex_0700F238[] = {
    {{{     0,    384,   -379}, 0, { 10188,   8162}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -168,    384,   -379}, 0, {  9514,   8162}, {0x00, 0x7f, 0x00, 0xff}}},
...
static const Vtx wf_seg7_vertex_0700F268[] = {
    ...
    {{{  -170,    384,   -380}, 0, { -1052,      0}, {0x88, 0x00, 0x28, 0xff}}},
    {{{     0,    384,   -380}, 0, {  1992,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{     0,    384,    128}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{     0,   -383,    127}, 0, {     0,   3032}, {0x7f, 0x00, 0x00, 0xff}}},
};
