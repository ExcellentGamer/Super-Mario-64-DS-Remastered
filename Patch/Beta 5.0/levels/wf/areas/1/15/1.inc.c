...
static const Vtx wf_seg7_vertex_0700A1F8[] = {
    ...
    {{{  1536,    102,   -769}, 0, { -7184,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{  1536,    102,    256}, 0, { -9228,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{  1536,   -153,    256}, 0, { -9228,    478}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{  1536,   -153,   -769}, 0, { -7184,    478}, {0x7f, 0x00, 0x00, 0xff}}},
...
static const Vtx wf_seg7_vertex_0700A358[] = {
    {{{  1538,    102,   -768}, 0, {   990,   5076}, {0x00, 0x7f, 0x00, 0xff}}},
    ...
    {{{ -1535,    102,   -768}, 0, {   990,    224}, {0x00, 0x7f, 0x00, 0xff}}},
};
