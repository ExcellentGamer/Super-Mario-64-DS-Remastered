...
static const Vtx wf_seg7_vertex_0700F0A0[] = {
    ...
    {{{   184,    384,   -379}, 0, { 17056,   8162}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{     0,    384,   -379}, 0, { 16320,   8162}, {0x00, 0x7f, 0x00, 0xff}}},
};
...
static const Vtx wf_seg7_vertex_0700F0D0[] = {
    ...
    {{{     0,    384,   -380}, 0, { -1032,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{     0,   -383,    128}, 0, {     0,   3032}, {0x77, 0x00, 0x2b, 0xff}}},
    {{{   184,    384,   -380}, 0, {  2122,      0}, {0x77, 0x00, 0x2b, 0xff}}},
    {{{     0,    384,    127}, 0, {     0,      0}, {0x77, 0x00, 0x2b, 0xff}}},
};
