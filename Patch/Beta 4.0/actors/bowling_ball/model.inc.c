...
Gfx bowling_ball_iron_ball_rgba32_aligner[] = {gsSPEndDisplayList()};
u8 bowling_ball_iron_ball_rgba32[] = "actors/bowling_ball/iron_ball.rgba32";

Gfx BlackBobBody_rgba32_aligner[] = {gsSPEndDisplayList()};
u8 BlackBobBody_rgba32[] = "actors/bowling_ball/BlackBobBody.rgba32";
...
Gfx mat_bowling_ball_f3d_material_003[] = {
	...
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_32b_LOAD_BLOCK, 1, bowling_ball_iron_ball_rgba32),
