...
const LevelScript level_bbh_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_HARD_BLOCK,                 hard_block_geo),
    ...
    AREA(/*index*/ 1, geo_bbh_000F00),
		...
		OBJECT_WITH_ACTS(/*model*/ MODEL_STAR_SWITCH, /*pos*/  -2644, -2457, 1655, /*angle*/ 0, 90, 0, /*behParam*/ 0x00100000, /*beh*/ bhvSm64DsStarSwitch,         /*acts*/ ACT_7),
		OBJECT_WITH_ACTS(/*model*/ MODEL_HARD_BLOCK, /*pos*/ -2644, -2457, 1655, /*angle*/ 0, 0, 0, /*behParam*/ 0x06000000, /*beh*/ bhvSm64DsBreakableBoxWario,         /*acts*/ ACT_7),
		OBJECT_WITH_ACTS(/*model*/ MODEL_GLASS, /*pos*/ 924, -2157, 1803, /*angle*/ 0,   0, 0, /*behParam*/ 0x06000000, /*beh*/ bhvSm64DsStarSpawnCondition, /*acts*/ ACT_7),
