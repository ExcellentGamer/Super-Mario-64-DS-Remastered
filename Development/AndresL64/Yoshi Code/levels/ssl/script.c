...
const LevelScript level_ssl_entry[] = {
    ...
    AREA(/*index*/ 1, ssl_geo_000648),
		...
		OBJECT_WITH_ACTS(/*model*/ MODEL_STAR_SWITCH, /*pos*/  5386, 0, -5881, /*angle*/ 0, 90, 0, /*behParam*/ 0x00100000, /*beh*/ bhvSm64DsStarSwitch,         /*acts*/ ACT_7),
		OBJECT_WITH_ACTS(/*model*/ MODEL_GLASS, /*pos*/ -6564, 322, -5974, /*angle*/ 0,   0, 0, /*behParam*/ 0x06000000, /*beh*/ bhvSm64DsStarSpawnCondition, /*acts*/ ACT_7),
