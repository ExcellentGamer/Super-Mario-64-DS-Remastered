...
const LevelScript level_thi_entry[] = {
    ...
    AREA(/*index*/ 2, thi_geo_0006D4),
		...
		OBJECT_WITH_ACTS(/*model*/ MODEL_STAR_SWITCH, /*pos*/ -1800, 1434, 1587, /*angle*/ 0, 90, 0, /*behParam*/ 0x00100000, /*beh*/ bhvSm64DsStarSwitch,         /*acts*/ ACT_7),
		OBJECT_WITH_ACTS(/*model*/ MODEL_GLASS, /*pos*/ -1926, 1530, -1882, /*angle*/ 0,   0, 0, /*behParam*/ 0x06000000, /*beh*/ bhvSm64DsStarSpawnCondition, /*acts*/ ACT_7),
