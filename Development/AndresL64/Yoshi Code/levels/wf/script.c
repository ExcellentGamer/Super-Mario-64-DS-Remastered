...
static const LevelScript script_func_local_4[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR_SWITCH,    /*pos*/  4600, 256,  128, /*angle*/ 0, 0, 0, /*behParam*/ 0x00100000, /*beh*/ bhvSm64DsStarSwitch,         /*acts*/ ACT_7),
    OBJECT_WITH_ACTS(/*model*/ MODEL_GLASS, /*pos*/ -2885, 684, -860, /*angle*/ 0, 0, 0, /*behParam*/ 0x06000000, /*beh*/ bhvSm64DsStarSpawnCondition, /*acts*/ ACT_7),
    RETURN(),
};
