...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_BETA_BOO_KEY, /*pos*/ 7134, -3322, 2169, /*angle*/ 0, 0, 0, /*behParam*/ 2, /*beh*/ bhvBetaBooKey, /*acts*/ ACT_2),
    RETURN(),
};
...
static const LevelScript script_func_local_3[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR_SWITCH,     /*pos*/   -50, -2966, -7100, /*angle*/ 0, 90, 0, /*behParam*/ 0x00070000, /*beh*/ bhvSm64DsStarSwitch,         /*acts*/ ACT_7),
    OBJECT_WITH_ACTS(/*model*/ MODEL_GLASS,           /*pos*/ -3650, -2666, -2900, /*angle*/ 0,  0, 0, /*behParam*/ 0x06000000, /*beh*/ bhvSm64DsStarSpawnCondition, /*acts*/ ACT_7),
    RETURN(),
};
