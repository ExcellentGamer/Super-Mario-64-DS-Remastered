...
const LevelScript level_ccm_entry[] = {
    ...
    AREA(/*index*/ 1, ccm_geo_00051C),
		...
		OBJECT_WITH_ACTS(/*model*/ MODEL_STAR_SWITCH, /*pos*/ -1071, -3583, 6085, /*angle*/ 0, 90, 0, /*behParam*/ 0x00070000, /*beh*/ bhvSm64DsStarSwitch,         /*acts*/ ACT_7),
		OBJECT_WITH_ACTS(/*model*/ MODEL_GLASS, /*pos*/ 2289, -3640,  4246, /*angle*/ 0,   0, 0, /*behParam*/ 0x06000000, /*beh*/ bhvSm64DsStarSpawnCondition, /*acts*/ ACT_7),
