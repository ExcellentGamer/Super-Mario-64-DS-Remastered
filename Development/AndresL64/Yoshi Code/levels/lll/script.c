...
static const LevelScript script_func_local_4[] = {
	...
	OBJECT(/*model*/ MODEL_GLASS,           /*pos*/ -5885,  454,  6873, /*angle*/ 0,   0, 0, /*behParam*/ 0x06000000, /*beh*/ bhvSm64DsStarSpawnCondition),
    OBJECT_WITH_ACTS(/*model*/ MODEL_SILVER_STAR,           /*pos*/ -6869,  207,  4271, /*angle*/ 0, 0, 0,    /*behParam*/ 0x00000000, /*beh*/ bhvSm64DsSilverStar,      /*acts*/ ACT_7),
    OBJECT_WITH_ACTS(/*model*/ MODEL_SILVER_STAR,           /*pos*/ -2970,  277, -2300, /*angle*/ 0, 0, 0,    /*behParam*/ 0x00000000, /*beh*/ bhvSm64DsSilverStar,      /*acts*/ ACT_7),
    OBJECT_WITH_ACTS(/*model*/ MODEL_SILVER_STAR,           /*pos*/ -6638,  200, -6637, /*angle*/ 0, 0, 0,    /*behParam*/ 0x00000000, /*beh*/ bhvSm64DsSilverStar,      /*acts*/ ACT_7),
    OBJECT_WITH_ACTS(/*model*/ MODEL_SILVER_STAR,           /*pos*/  6192,  839, -6450, /*angle*/ 0, 0, 0,    /*behParam*/ 0x00000000, /*beh*/ bhvSm64DsSilverStar,      /*acts*/ ACT_7),
    OBJECT_WITH_ACTS(/*model*/ MODEL_SILVER_STAR,           /*pos*/  6651,   85, -2458, /*angle*/ 0, 0, 0,    /*behParam*/ 0x00000000, /*beh*/ bhvSm64DsSilverStar,      /*acts*/ ACT_7),
    OBJECT_WITH_ACTS(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/  1050,  550,  8200, /*angle*/ 0,   0, 0, /*behParam*/ 0x00030000, /*beh*/ bhvExclamationBox, /*acts*/ ACT_5 | ACT_6),
