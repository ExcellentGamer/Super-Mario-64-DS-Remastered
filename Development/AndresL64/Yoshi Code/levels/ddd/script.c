...
const LevelScript level_ddd_entry[] = {
    ...
    AREA(/*index*/ 2, ddd_geo_000570),
		OBJECT_WITH_ACTS(/*model*/ MODEL_STAR_SWITCH, /*pos*/ 6806, 110, 1509, /*angle*/ 0, 90, 0, /*behParam*/ 0x00100000, /*beh*/ bhvSm64DsStarSwitch,         /*acts*/ ACT_7),
		OBJECT_WITH_ACTS(/*model*/ MODEL_GLASS, /*pos*/ 5799, -3600, -152, /*angle*/ 0,   0, 0, /*behParam*/ 0x06000000, /*beh*/ bhvSm64DsStarSpawnCondition, /*acts*/ ACT_7),
