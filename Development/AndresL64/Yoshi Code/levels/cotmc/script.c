...
const LevelScript level_cotmc_entry[] = {
    ...
    AREA(/*index*/ 1, cotmc_geo_0001A0),
        OBJECT(/*model*/ MODEL_WARIO_COIN_LUNAR, /*pos*/ -4675,  30,  -105, /*angle*/ 0, 0, 0, /*behParam*/ 4, /*beh*/ bhvWarioCoin),
        OBJECT(/*model*/ MODEL_WARIO_COIN_MARIO, /*pos*/ 7,  -143,  2141, /*angle*/ 0, 0, 0, /*behParam*/ 5, /*beh*/ bhvWarioCoin),
