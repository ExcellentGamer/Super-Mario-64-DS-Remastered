...
extern Vtx thwomp_thwomp_model_mesh_vtx_0[417];
extern Gfx thwomp_thwomp_model_mesh_tri_0[];
extern Gfx thwomp_thwomp_model_mesh[];
...
#include "yoshi_egg/geo_header.h"
