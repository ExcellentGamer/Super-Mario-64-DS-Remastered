...
#define MODEL_SILVER_STAR                      0xF7        // silver_star_geo
#define MODEL_GLASS                            0xF8        // glass_geo
#define MODEL_STAR_SWITCH                      0xF9        // star_switch_geo
#define MODEL_HARD_BLOCK                       0xE8        // hard_block_geo
#define MODEL_WHOMP_KING                       0xFA        // king_whomp_geo
