...
Gfx bobomb_000_offset_005_buddy_mesh_layer_4[] = {
	gsSPDisplayList(mat_bobomb__3D_Red_Bomb),
	gsSPDisplayList(bobomb_000_offset_005_mesh_layer_4_tri_1),
	gsSPDisplayList(mat_revert_bobomb__3D_Red_Bomb),
	gsSPEndDisplayList(),
};
...
Gfx bobomb_000_offset_008_buddy_mesh_layer_4[] = {
	gsSPDisplayList(mat_bobomb__3D_Red_Bomb),
	gsSPDisplayList(bobomb_000_offset_008_mesh_layer_4_tri_1),
	gsSPDisplayList(mat_revert_bobomb__3D_Red_Bomb),
	gsSPEndDisplayList(),
};
...
Gfx bobomb_006_offset_buddy_mesh_layer_4[] = {
	gsSPDisplayList(mat_bobomb__3D_Red_Bomb),
	gsSPDisplayList(bobomb_006_offset_mesh_layer_4_tri_1),
	gsSPDisplayList(mat_revert_bobomb__3D_Red_Bomb),
	gsSPEndDisplayList(),
};
